...
![830cef13b07bfbf4c5cb1a011b4da28f.png](:ROV/ba15e74a6af343f78d3d633cdd888975.png)
...
![f87f6cad7e649802c0ad33f7bbcf190f.png](:ROV/6ff38e16faee4b3dabe86701eb915493.png)


It consists of different functionalities in each block of the design:


![b7b5681e74e71c8aef708ccb31f29ef5.png](:ROV/1025dd921c8f4e64863e1b927f7b474d.png)
...
![77e51ca49fc29e00e835b61a44edc983.png](:ROV/3a66c0082e9f4b27853c2c211540bb84.png)


This error signal, in the world frame, is converted to the error signal in body frame 𝑒b using the following equation:


![417cc79906edd0b83ea42a11b62be8fd.png](:ROV/47fe8a2f89884e2688f4279da646f101.png)
...
![a93d9718ed2b18066a20ae419527faf7.png](:ROV/4737c01842e74f708bd2d13e29929148.png)


![6f40861dfc2f8731564b2e8047f8d90d.png](:ROV/9ff4a74c26b246158e5495abc744f02f.png)


Using the error signal in the body frame 𝑒b, the torque generated by the PID can be calculated using the equation:


![eed4b8c10aefd5cb9b9f951ffd46d73f.png](:ROV/655ee50fa1974dfb9e902e8b38cf34a6.png)
...
![51c6bc2730ae57e3c1287fbeb9f62ab1.png](:ROV/26f0b443d372489690759e7502530396.png)


As a result, the control input vector can be derived as:


![07231a3d70e4419415f34b7024ddd8a5.png](:ROV/f731096bac0046c19e275ab9afa10212.png)


For the linear model, the following values of KP, KI, and KD have been obtained using the Ziegler-Nichols method:


![0b0304625973d6a5c95adcd9811e5754.png](:ROV/5de4671bcbf44efaa0f44a2f18744f4c.png)


![09aa1fa8ee8b9bdfdb03a88e75db286a.png](:ROV/c49e442eb3ea4c768ed4afc2afdff37f.png)
...
![b7f9684fc715142cb0228725470cb340.png](:ROV/e411470313c44dfd96bab38671792fca.png)
...
![1ec509f8030c6805152671b9a79bf51c.png](:ROV/96169c62711642e599f8b1084cd97a6f.png)
...
![3fdcb4d9dd9822a4913feb301e1142bd.png](:ROV/7c3e552fe8ef49cdadcb581996cdb9f0.png)
...
![e8fe240722b97ff01cc6a4190694cc3f.png](:ROV/d811d9409d9843aa9b5c60d1107003b0.png)
...
![fe6dbb5745ef6800216b5a3d32d63187.png](:ROV/129f58e9c2f24d07949ee84f266e825c.png)


Finally, the control law for the nonlinear model-based PID controller is computed given by:


![3589babf62fbea27ed46fc2d89aa35d7.png](:ROV/3266f33f3292482abd0f116229289515.png)


The final model for this system is shown below:


![f19c09e97f93f0911ae4bf17dbeb2576.png](:ROV/f3fc12aa6d8a4a3d95ed3389f4b3b541.png)
...
![6dd2f63f9cb923bf64a25d0ea9ad417d.png](:ROV/af61e98355d24e28a72f77ecc0595853.png)
...
![ee0631cd3fa4a2153e3432fd9fc065bc.png](:ROV/a1f09339cf7e4e95b06c1994106d7893.png)
...
![b35b66d57776b02dbb3463af11d7f7b0.png](:ROV/2537b8495a8349f58dd99b527b3fc3c2.png)
...
![fd6ac83dd3f5712d12140a36d56e7b40.png](:ROV/285a62905f924269bd61c1a3fcf674c6.png)
...
![b8e1975a6390c95d21f8a157c8c9eee4.png](:ROV/2232b99d96a04baebe03d95dff546051.png)
...
![b8ef6857c1dff9c3a00c338d87099cf7.png](:ROV/fd564d5164c7439b9ce10bf865aee67c.png)
...
![ca854252df064c4c92a93e74eccf4700.png](:ROV/6194bc22daaf4c75be736403862b03f1.png)
...
![ce70afa386d5206382d8b4e3d6b4922c.png](:ROV/bd6740c3627e4057a837adf471880e8c.png)
...
![3fc81ad4c98b59f9151b5da2a47250bb.png](:ROV/c66d1d5df3ab4d7aa172690a8a71ca9f.png)
...
![049900d09da565b9cc9ea01fd09bf72c.png](:ROV/8d03e9be9f7244989d72f4e29d01994f.png)
...
![6c4497a819a14611b434408d2b840cea.png](:ROV/eb8411ac6bf84469932bf6e0953a223e.png)
...
![f0d6456818c32efc7a8396b70cf65a5b.png](:ROV/c57042350e174e569fbb0a2fbde7be89.png)
...
![2b7a2cb84c02c6fd815a8337972f5c42.png](:ROV/e68ffc2359ac45ceb0f861486b3ddbe5.png)
...
![2fbc87c6757c50cf0ad43df0d079c012.png](:ROV/5ddad0dc188045598508698457d50be5.png)
...
![a4a80de355e7d85284f09286e812d113.png](:ROV/dc39b68c1cf747968f2ab5954fccce0e.png)
...
![d23f8327ad6daf6c43da413ee9008f73.png](:ROV/deff84a9affd4c869b854651efb92ef5.png)
...
![80835ab6d570de6cd5bb53d4d59e758a.png](:ROV/156d740230b54c1fa19999bc70578f28.png)
...
![fc09bc78a5d891afa4282765192504b5.png](:ROV/f8edeebb53274bfb8def84a0017c67a8.png)
...
![748fccdb27d3c763a7e3767457795874.png](:ROV/dc6404ca0d9a487c814cd4c0451bfe46.png)
...
![8ea1dd2ddcff1483c74bdd93f16b209b.png](:ROV/f350ff9587fa40a2942756c2f20eafc4.png)
...
![712086ebf11a62836b19e3b14a6dcfa6.png](:ROV/5d9c384663dc4e89b0e2d67b5c9b7da3.png)

(Here x is the state but not the distance in x direction)

![142a0e6ea79541a35773eccf39171f5c.png](:ROV/beaab453c88c486cb0cdbed7dec1146d.png)

Since,

![c0e5ecf56a58ece1c31cfb62ba91c11d.png](:ROV/41c6f6db8ba94427939ee65ebb8b7b5f.png)

The above state space model is clearly non-linear. So, we have to linearise to find A and B as follows:

![2aae6563a52e45984d0b1a1dcfa2e7db.png](:ROV/00f72a17d7fb446082e933b086767774.png)

![af91d34d2ea4b80fd03a465693c32274.png](:ROV/2b159be790c44f7caa395ac9ca2a7eb6.png)

So, we obtain the A and B as follows:

![91c08a5c76f6fc5ad7ae86eb421cf27d.png](:ROV/f259130897a043afb305707acb8a8aa0.png)

![8e087d19d37c13d3b034a15384ddc4cd.png](:ROV/a08757dfd53d42bdb53eb7ea1bb1cb58.png)
...
![4104dd02cea08608622bc89c07daa6a4.png](:ROV/40d3bbd8fa894a248b19fc9b53f9b152.png)

![994c76fe82c7d017fe82243f0bb41fb5.png](:ROV/e578e2b5906a42bd9f5b4860b1a3b73b.png)

For the above, the Poles of the closed loop and open loop transfer function are as follows:

![d3a196bc57240dc8161ac4ea944af02b.png](:ROV/30bbfd184f3f4806abf18ea647a496e6.png)

**Poles:**

Closed loop(With the feedback):

![061fa80a7756df24211d1b4d097fe725.png](:ROV/a2c6f3f9ea8547de92f8a444e8328b5b.png)

Open loop(Without the feedback):

![c0877a5f9abc58098a692e719e769e33.png](:ROV/f311ff15b4034f34b95720fb3c5648b9.png)

**Making ‘R’ more dominant:**

![0a299e2db190fad74d6f9e2f88efd6e1.png](:ROV/6d0af97064c84ba7b8f797024f28beb2.png)

![56f9c54d900167e9d18db63d87d96ee6.png](:ROV/8656a4d3f7814f34bd8ab45108f3a929.png)

**Making ‘R’ less dominant:**

![34181b2ba6567f3ef123a0d634f6901c.png](:ROV/28b22a4f42794f229fde8a5380ae6cf7.png)

![3d8ec25ac866c2b5886716d673be3a53.png](:ROV/6561da1ed4fa4a98a921d2cd8902d0e0.png)

**Results:**
**a) Observed states:**

![bb14c98dc1bd81d35bf7b4b72ec495d0.png](:ROV/d2336d884fee4f06b9e91c43525e012a.png)

**More dominant ‘R’:**

![b09eec3e2c852d80d02da4042192b1c9.png](:ROV/d85a90c729dc42b5aeb4e1ccec83b3d3.png)

**Less dominant ‘R’:**

![793213287588f45a5936f9219b9af761.png](:ROV/d8e226d0f41b4de3af45b807ab0ae9d9.png)

**b)Thrust i/p to the thrusters:**

![2aa69e4f7190c4f7d0a4419b3901a2aa.png](:ROV/5bacd3b2aa6a4422a0810406551c9b07.png)

**More dominant ‘R’:**

![f39fd171ac6ca335df05a27063036221.png](:ROV/dab7c0d1ba0f4d47930f883a9ac385e9.png)

**Less dominant ‘R’:**

![3db8245fd5f095e284e21b4742a5e61c.png](:ROV/5744088635ca460199fc8911f1944d86.png)

**Band Limited White Noise:**
We planned on modelling a system with White Noise. So, we used the following control system:

![bfdb73fd484320597f24964ecbbdc68a.png](:ROV/1a759a49ab594fc8a0e3e659010efe1b.png)

Where:

![55510b503970cac67342e94677db8b3b.png](:ROV/33783a5c8fb54a65a04f573d211342ed.png)
...
![3fd5489e8fe53d1272e38c9c7a23d0e6.png](:ROV/cf5ab790e01c4244b08425844e3d11fe.png)

**Thrust provided by each thruster:**

![fbfba474def7cda9bef422f71e9cb89a.png](:ROV/75ab7a69a6d242e9860841008f1515f4.png)

**Poles of this system:**

![dbdcd2edf68d27a124b6081791c89f6f.png](:ROV/7b6eac6befa8438fbc892e3d3b4ecff6.png)

2)Q = 1000*eye(12):
**States:**

![59d1bcdf6acc9cdf751600810927f1b5.png](:ROV/feb61203b15f4354a7bb48e00f8e0b9a.png)

**Thrust provided by each thruster:**

![7a0e73544f01235f28db9fbf3a9d016c.png](:ROV/a6e07695ba6f4999b519a13558938f29.png)

**Poles of this system:**

![f799dfc5b6b2c72c911a440bee7b96f6.png](:ROV/9d636758f7a440acaec699f956736ebc.png)
...
![ecd0084c0d6067a60aa22db5291725a1.png](:ROV/def322c78940424aa63da117cbf61f21.png)

The parameters of the noise block are as follows:

![b48f8981333efba2566f13021a6fc59b.png](:ROV/33acf7dae9994f50a303975e281ae764.png)
...
![be82d3ac55f54be0302f73a5b10ffe29.png](:ROV/e2b0399adc6744509cdabb205b4bf7b6.png)

**Thrust provided by each thruster:**

![df475dc8004aaff25c34702615f38cdc.png](:ROV/c6bb1a078b3940d5868cdaad3017fc2c.png)
...
![27784a165aef27fed02596dd27ecb713.png](:ROV/af4a4b0d798a48c1a1ea734edaab0e2c.png)
...
![46692c69ab6f1295f167649595df7c68.png](:ROV/e50e14ce1eb1448684a02d55c8921f5c.png)
